 ...
 * @Description 格式化输出Json或者对象
 * @author lebron
 * @Date Oct 24, 2017 10:18:09 AM
 * @version 1.0.0
 */
public class JsonFormatTool {
    ...
    public static String formatJson(Object object) throws JsonProcessingException {
        String json = MAPPER.writeValueAsString(object);
        return formatJson(json);
    }

    /**
     * 返回指定次数的缩进字符串。每一次缩进四个空格，即SPACE。
     * 
     * @param number
     *            缩进次数。
     * @return 指定缩进次数的字符串。
